...
\begin{table}[!ht]
	...
	\begin{tabular}{p{10cm} p{10cm} }
	    \textbf{Exp. Name: }p5726 & \textbf{Date/Time: }10/05/2022\\
	    \textbf{Operator(s): }Wood & Hydraulics start: 5306.7 \\
...
\begin{table}[ht!]
        ...
        \begin{tabular}{ |p{2.75cm}|p{4cm}|p{3.5cm}|p{2.5cm}| p{3cm}| }
            ...
            \hline
            44mm Solid Horiz & \begin{tabular}[c]{@{}l@{}}129.984\\ (V/MPa): 0.289\end{tabular} & 4, 9.25, 18 & 0.072 & 1.22789, 2.74499, 5.27349\\ \hline44mm Solid Vert & \begin{tabular}[c]{@{}l@{}}120.364\\ (V/MPa): 0.2676\end{tabular} & 0 & 0 & 0.\\ \hline
    \end{tabular}
    \end{table} \vspace{-0.5cm} 
...
\begin{table}[ht!]
            ...
            \textbf{Calibrations (V/MPa)} & \textbf{Pressures (MPa)} & \textbf{Init. Voltage} & \textbf{Volt. @ load} \\ \hline\textit{\small Pc:} 0.1456 & 2, 8.25, 12 & 0.026 & 0.3172, 1.2272, 1.7732\\ \hline\textit{\small PpA:} 1.5177 & 2.6, 1.4 & 0 & 3.94602, 2.12478\\ \hline\textit{\small PpB:} 1.483 & 2.6 & 0 & 3.8558\\ \hline \end{tabular}
        \end{table} \vspace{-0.5cm} 
...
\newpage 
 ...
 \setlength\itemsep{0.25em}
 	 \item 125 NS to 10 kN
 	 \item 950 Pc to 2 MPa
 	 \item top seal leaks significantly. empty vessel. replace seal. 
 \end{itemize}} 
